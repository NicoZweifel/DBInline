namespace DBInline.Interfaces
{
    ...
    {
        public new IQueryBuilder<TBuilder> Where(string clause);
        public new IQueryBuilder<TBuilder> Where(string fieldName, object value);
    ...
    {
        public new IQueryBuilder<TBuilder, TOut> Where(string clause);
        public new IQueryBuilder<TBuilder, TOut> Where(string fieldName, object value);
